...
import com.trials.amazonaws.mobile.user.IdentityManager;
import com.trials.supertriathlon.R;
import com.trials.supertriathlon.SuperTriathlon;
import com.trials.userpreference.demo.DemoConfiguration;
import com.trials.userpreference.navigation.NavigationDrawer;
import com.trials.userpreference.demo.HomeDemoFragment;

import static com.trials.supertriathlon.HasScenes.SCENE_OPENING;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        sCurrentFragment = MainActivity.class.getSimpleName();
    ...
    public void onBackPressed() {
        ...
        if (sCurrentFragment.equals(HomeDemoFragment.class.getSimpleName())) {
            // to be back in opening scene.
            Intent intent = new Intent(MainActivity.this,SuperTriathlon.class);
    ...
    public static void setCurrentFragment(String simpleClassName) { sCurrentFragment = simpleClassName; }
