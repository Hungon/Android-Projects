...
public class DemoConfiguration {
    ...
    static {
        addDemoFeature("register", R.mipmap.icon_register, R.string.feature_register_title,
                R.string.feature_register_subtitle, R.string.feature_register_overview,
                R.string.feature_register_description, R.string.feature_ranking_powered_by,
                new DemoItem(R.string.main_fragment_title_register, R.mipmap.icon_register,
                        R.string.feature_participate_button, RegisterInfoFragment.class));
        addDemoFeature("ranking", R.mipmap.icon_ranking, R.string.feature_ranking_title,
            R.string.feature_ranking_subtitle, R.string.feature_ranking_overview,
            R.string.feature_ranking_description, R.string.feature_ranking_powered_by,
            new DemoItem(R.string.main_fragment_title_ranking_database, R.mipmap.icon_ranking,
                R.string.feature_show_ranking_button, NoSQLSelectTableDemoFragment.class));
    }
